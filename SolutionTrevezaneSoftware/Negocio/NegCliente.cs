    ...
    public class NegCliente
    {
        ...
        public Boolean CadastrarCliente(Cliente cliente)
        {
            try
            {
                ...
                sqlserver.AdicionarParametro(new System.Data.SqlClient.SqlParameter("@estatus", cliente.estatusCliente));
                sqlserver.AdicionarParametro(new System.Data.SqlClient.SqlParameter("@observacao", cliente.observacaoCliente));


                string comando = "exec uspCadastrarCliente " +
                    "@prontuario, @nis, @nome, @sobrenome, @dataNascimento, @sexo, @rg, @cpf, @endereco, @bairro, @numero, @cidade, @estado, " +
                    "@cep, @telefone, @celular, @email, @estatus, @observacao";
        ...
        public Boolean AtualizarCliente(Cliente cliente)
        {
            try
            {
                ...
                string comando = "exec uspAlterarCliente @codigo, @prontuario, @nis, @nome, @sobrenome, @dataNascimento, @sexo, @rg, @cpf, @endereco, @bairro, @numero, @cidade, " +
                    "@estado, @cep, @telefone, @celular, @email, @estatus, @observacao";
        ...
        //--------------------------Consultas
        public ClienteLista BuscarClientePorNome(string nomeCliente, string estatus) {
            try
            {
                ...
                string comando = "exec uspBuscarClientePorNome @nome, @estatus";
                ...
                foreach (DataRow registro in tabelaResultado.Rows)
                {
                    ...
                    cliente.prontuarioCliente = registro[1].ToString();
                    cliente.nisCliente = registro[2].ToString();
                    cliente.nomeCliente = registro[3].ToString();
                    cliente.sobrenomeCliente = registro[4].ToString();
                    cliente.dataNascimentoCliente = Convert.ToDateTime(registro[5]);
                    cliente.sexoCliente = registro[6].ToString();
                    cliente.rgCliente = registro[7].ToString();
                    cliente.cpfCliente = registro[8].ToString();
                    cliente.enderecoCliente = registro[9].ToString();
                    cliente.bairroCliente = registro[10].ToString();
                    cliente.numeroCliente = Convert.ToInt32(registro[11]);
                    cliente.cidadeCliente = registro[12].ToString();
                    cliente.estadoCliente = registro[13].ToString();
                    cliente.cepCliente = registro[14].ToString();
                    cliente.telefoneCliente = registro[15].ToString();
                    cliente.celularCliente = registro[16].ToString();
                    cliente.emailCliente = registro[17].ToString();
                    cliente.dataCadastro = registro[18].ToString();
                    cliente.estatusCliente = registro[19].ToString();
                    cliente.observacaoCliente = registro[20].ToString();
        ...
        public Cliente BuscarClientePorCpf(string cpfBuscar, string estatus)
        {
            try
            {
                DataTable tabelaResultado;
                ...
                string comando = "exec uspBuscarClientePorCpf @cpf, @estatus";
