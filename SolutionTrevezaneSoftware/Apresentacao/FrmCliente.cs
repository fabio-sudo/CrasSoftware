    ...
    public partial class FrmCliente : Form
    {
        ...
        private void AtualizarDataGrid()
        {
            ...
            foreach (Cliente clie in this.clienteLista)
            {
                ...
                this.dgvCliente[1, indice].Value = clie.prontuarioCliente;
                this.dgvCliente[2, indice].Value = clie.nisCliente;
                this.dgvCliente[3, indice].Value = clie.nomeCliente;
                this.dgvCliente[4, indice].Value = clie.sobrenomeCliente;
                this.dgvCliente[5, indice].Value = clie.sexoCliente;
                this.dgvCliente[6, indice].Value = clie.rgCliente;
                this.dgvCliente[7, indice].Value = clie.cpfCliente;
                this.dgvCliente[8, indice].Value = clie.dataNascimentoCliente;
                this.dgvCliente[9, indice].Value = clie.enderecoCliente;
                this.dgvCliente[10, indice].Value = clie.bairroCliente;
                this.dgvCliente[11, indice].Value = clie.numeroCliente;
                this.dgvCliente[12, indice].Value = clie.cepCliente;
                this.dgvCliente[13, indice].Value = clie.cidadeCliente;
                this.dgvCliente[14, indice].Value = clie.estadoCliente;
                this.dgvCliente[15, indice].Value = clie.telefoneCliente;
                this.dgvCliente[16, indice].Value = clie.celularCliente;
                //this.dgvCliente[17, indice].Value = clie.emailCliente;
                this.dgvCliente[17, indice].Value = clie.dataCadastro;
                this.dgvCliente[18, indice].Value = clie.estatusCliente;
                this.dgvCliente[19, indice].Value = clie.observacaoCliente;
        ...
        private string metodoFiltro() {
            ...
            string cadAtivoInativo = "";

            if (cbAtivo.Checked == true && cbInativo.Checked == true)
            {
                cadAtivoInativo = "";

            }
            else if (cbAtivo.Checked == false && cbInativo.Checked == true)
            {

                cadAtivoInativo = "BLOQUEADO";
            }
            else if (cbAtivo.Checked == true && cbInativo.Checked == false)
            {
                cadAtivoInativo = "ATIVO";
            }
            else { cadAtivoInativo = ""; }


            return cadAtivoInativo;
        
        }

        //atualiza os valores no Data Grid
        private void AtualizarDataGridFiltro(Cliente clie)
        {
            this.dgvCliente.Rows.Clear(); // Limpa todos os registros atuais no grid de funcionários.

            if (clie != null)
            {
                this.dgvCliente.Rows.Add(1);
                ...
                tbBuscarCliente.Text = clie.nomeCliente;
            }
        }
        ...
        private void btBuscar_Click(object sender, EventArgs e)
        {
            ...
            string cadAtivoInativo = metodoFiltro();//Retorna filtro para trazer clientes ativos ou inativos

            this.clienteLista = ncliente.BuscarClientePorNome(cliente, cadAtivoInativo);
        ...
        private void pbFiltrar_Click(object sender, EventArgs e)
        {
            ...
            this.clienteFiltro = ncliente.BuscarClientePorCpf(cpf, cadAtivoInativo);
            AtualizarDataGridFiltro(clienteFiltro);
        }

        private void btImprimir_Click(object sender, EventArgs e)
        {
            ViewRelatorioCliente relCliente = new ViewRelatorioCliente();
            relCliente.ShowDialog();
        }
