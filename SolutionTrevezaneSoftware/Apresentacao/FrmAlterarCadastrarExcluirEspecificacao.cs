...
{
    public partial class FrmAlterarCadastrarExcluirEspecificacao : FrmModelo
    {
        string modeloFormulario;
        Especificacao especificacao;
        private NegEspecificacao  nEspecificacao = new NegEspecificacao();

        public FrmAlterarCadastrarExcluirEspecificacao(string strFormulario, [Optional] Especificacao obj)
        {
            InitializeComponent();
        ...
        public void metodoConstrutor()
        {
            ...
            {
                this.Text = "Cadastrar Especificação do Atendimento";
                tbId.Visible = false;
                lbCodigo.Visible = false;
                this.btCadastrar.BackColor = System.Drawing.Color.Turquoise;
                this.btCadastrar.Text = "F10 Cadastrar";
                btExcluir.Visible = false;
                cbNenhum.Checked = true;

            }
            else
            {
                this.Text = "Alterar e Excluir Especificação do Atendimento";
                ...
                tbId.Text = especificacao.idEspecificacao.ToString();
                tbDescricao.Text = especificacao.descricaoEspecificacao;



                if (especificacao.encaminhamentoEspecificacao == "Nenhum")
                {
                    cbNenhum.Checked = true;
                }
                else if (especificacao.encaminhamentoEspecificacao == "Enviado")
                {
                    cbEnviado.Checked = true;
                }
                else if (especificacao.encaminhamentoEspecificacao == "Recebido")
                {
        ...
        private void FrmAlterarCadastrarExcluirEspecificacao_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void FrmAlterarCadastrarExcluirEspecificacao_Load(object sender, EventArgs e)
        {
            metodoConstrutor();
        }
        ...
        private void btCadastrar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Especificacao cad = new Especificacao();

                    //tipoAtendimento.idTipo = int.Parse(tbId.Text);
                    cad.descricaoEspecificacao = tbDescricao.Text;

                    if (cbNenhum.Checked == true)
                    {
                        cad.encaminhamentoEspecificacao = cbNenhum.Text;
                    }
                    else if (cbEnviado.Checked == true)
                    {
                        cad.encaminhamentoEspecificacao = cbEnviado.Text;
                    }
                    else if (cbRecebido.Checked == true)
                    {
                        cad.encaminhamentoEspecificacao = cbRecebido.Text;
                    }

                    if (nEspecificacao.CadastrarEspecificacao(cad) == true)
                    {
                        DialogResult resposta;
                        //Criando Caixa de dialogo
                        FrmCaixaDialogo frmCaixa = new FrmCaixaDialogo("Confirmação",
                ...
                else//Alterar
                {
                    ...
                    if (metodoValidaCampos() == true)
                    {
                        ...
                        if (resposta == DialogResult.Yes)
                        {
                            Especificacao alt = new Especificacao();

                            alt.idEspecificacao = int.Parse(tbId.Text);
                            alt.descricaoEspecificacao = tbDescricao.Text;
                            if (cbNenhum.Checked == true)
                            {
                                alt.encaminhamentoEspecificacao = cbNenhum.Text;
                            }
                            else if (cbEnviado.Checked == true)
                            {
                                alt.encaminhamentoEspecificacao = cbEnviado.Text;
                            }
                            else if (cbRecebido.Checked == true)
                            {
                                alt.encaminhamentoEspecificacao = cbRecebido.Text;
                            }
                            //Realizando o Cadastro
                            if (nEspecificacao.AtualizarEspecificacaoAtendimento(alt) == true)
                            {
        ...
        private void btExcluir_Click(object sender, EventArgs e)
        {
            ...
            if (resposta == DialogResult.Yes)
            {
                if (nEspecificacao.ExcluirEspecificacao(especificacao) == true)
                {
                    //Criando Caixa de dialogo
