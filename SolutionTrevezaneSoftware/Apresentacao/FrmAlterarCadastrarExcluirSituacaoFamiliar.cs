...
{
    public partial class FrmAlterarCadastrarExcluirSituacaoFamiliar : FrmModelo
    {
        string modeloFormulario;
        SituacaoFamiliar situacao;
        private NegSituacaoFamiliar nSituacao = new NegSituacaoFamiliar();

        public FrmAlterarCadastrarExcluirSituacaoFamiliar(string strFormulario, [Optional] SituacaoFamiliar objSituacao)
        {
            InitializeComponent();
        ...
        public void metodoConstrutor()
        {
            ...
            {
                this.Text = "Cadastrar Situação Familiar";
                tbId.Visible = false;
            ...
            {
                this.Text = "Alterar e Excluir Situação Familiar";
                ...
                tbId.Text = situacao.idSituacaoFamiliar.ToString();
                tbDescricao.Text = situacao.descricaoSituacaoFamiliar;
            }
        ...
        private void btCadastrar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    SituacaoFamiliar cadSituacao = new SituacaoFamiliar();

                    //tipoAtendimento.idTipo = int.Parse(tbId.Text);
                    cadSituacao.descricaoSituacaoFamiliar = tbDescricao.Text;
                ...
                else//Alterar
                {
                    ...
                    if (metodoValidaCampos() == true)
                    {
                        ...
                        if (resposta == DialogResult.Yes)
                        {
                            SituacaoFamiliar altSituacao = new SituacaoFamiliar();

                            altSituacao.idSituacaoFamiliar = int.Parse(tbId.Text);
                            altSituacao.descricaoSituacaoFamiliar = tbDescricao.Text;
        ...
        private void btExcluir_Click(object sender, EventArgs e)
        {
            ...
            if (resposta == DialogResult.Yes)
            {
                if (nSituacao.ExcluirSituacao(situacao) == true)
                {
                    //Criando Caixa de dialogo
        ...
        private void FrmAlterarCadastrarExcluirSituacaoFamiliar_Load(object sender, EventArgs e)
        {
            metodoConstrutor();

        }

        private void FrmAlterarCadastrarExcluirSituacaoFamiliar_KeyDown(object sender, KeyEventArgs e)
        {
