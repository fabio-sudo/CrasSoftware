...
namespace Apresentacao
{
    public partial class FrmAlterarExcluirCliente : Form
    {
        ...
        public void metodoIniciaFormulario()
        {
            ...
            this.tbProntuario.Text = clienteCorrente.prontuarioCliente;
            this.mtbNis.Text = clienteCorrente.nisCliente;
            ...
            this.tbObservacao.Text = clienteCorrente.observacaoCliente;

            if (clienteCorrente.estatusCliente == "BLOQUEADO")
            {
        ...
        {
            if (tbProntuario.Text.Trim() == String.Empty)
            {
                MessageBox.Show("Informe o prontuário do Cliente!",
            ...
            else if (tbNome.Text.Trim() == String.Empty)
            {
            ...
            else if (mtbNis.Text.Trim() == String.Empty)
            {
                MessageBox.Show("Informe o NIS Cliente!",
                        "Erro", MessageBoxButtons.OK, MessageBoxIcon.Error);
                mtbNis.Clear();
                mtbNis.Focus();
        ...
        private void btAlterar_Click(object sender, EventArgs e)
        {
          try
            ...
            if (metodoValidaCampos() == true)
            {
                ...
                DialogResult respostaCad;
                //Criando Caixa de dialogo
                FrmCaixaDialogo frmCaixa = new FrmCaixaDialogo("Campos Vazios",
                ...
                respostaCad = frmCaixa.ShowDialog();
                if (respostaCad == DialogResult.Yes)
                {

                    varCadastra = true;
                }
                else { varCadastra = false; }
            }
            ...
            {          
                ...
                if (resposta == DialogResult.Yes)
                {
                    ...
                    clienteAlterado.prontuarioCliente = tbProntuario.Text;
                    clienteAlterado.nisCliente = mtbNis.Text;
                    ...
                    clienteAlterado.observacaoCliente = tbObservacao.Text;
                    clienteAlterado.estatusCliente = lbEstatus.Text;
        ...
        private void tbProntuario_Leave(object sender, EventArgs e)
        {
            //Verifica se o campo for preenchido
            if (tbProntuario.Text == String.Empty)
            {
                epCliente.SetError(tbProntuario, "Campo obrigatório!");
                return;
            }
            else
                epCliente.Clear();
        ...
        private void mtbNis_Leave(object sender, EventArgs e)
        {
            if (mtbNis.Text == String.Empty)
            {
                epCliente.SetError(mtbNis, "Campo obrigatório!");
            }
            else
                epCliente.Clear();
        }

        private void tgBloqueio_CheckedChanged(object sender, EventArgs e)
        {
        ...
        {
            if (lbEstatus.Text == "ATIVO")
            {
                lbEstatus.Text = "BLOQUEADO";
            }
            else { lbEstatus.Text = "ATIVO"; }
        }
