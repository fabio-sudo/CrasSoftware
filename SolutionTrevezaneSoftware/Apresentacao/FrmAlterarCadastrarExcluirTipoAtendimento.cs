...
{
    public partial class FrmAlterarCadastrarExcluirTipoAtendimento : FrmModelo
    {
        string modeloFormulario;
        TipoAtendimento tipoAtendimento;

        public FrmAlterarCadastrarExcluirTipoAtendimento(string strFormulario, [Optional]TipoAtendimento tipo)
        {
            InitializeComponent();
        ...
        public void metodoConstrutor()
        {
            ...
            {
                this.Text = "Cadastrar Tipo de Atendimento";
                tbId.Visible = false;
            ...
            {
                this.Text = "Alterar e Excluir Tipo de Atendimento";
                ...
                tbId.Text = tipoAtendimento.idTipo.ToString();
                tbDescricao.Text = tipoAtendimento.descricaoTipo;
            }
        ...
        //--------------------Formulário
        private void FrmAlterarCadastrarExcluirTipoAtendimento_Load(object sender, EventArgs e)
        {
            metodoConstrutor();
        }
        ...
        private void btCadastrar_Click(object sender, EventArgs e)
        {
            ...
            {     
                if (modeloFormulario == "cadastrar")//Cadastrar
                {
                    ...
                    tipoAtendimento.descricaoTipo = tbDescricao.Text;

                    if (nTipo.CadastrarTipoAtendimento(tipoAtendimento) == true)
                    {
                        DialogResult resposta;
                        //Criando Caixa de dialogo
                        FrmCaixaDialogo frmCaixa = new FrmCaixaDialogo("Confirmação",
                ...
                else//Alterar
                {
                    ...
                    if (metodoValidaCampos() == true)
                    {
                        ...
                        if (resposta == DialogResult.Yes)
                        {
                            TipoAtendimento tipoAlterado = new TipoAtendimento();

                            tipoAlterado.idTipo = int.Parse(tbId.Text);
                            tipoAlterado.descricaoTipo = tbDescricao.Text;

                            //Realizando o Cadastro
                            if (nTipo.AtualizarTipoAtendimento(tipoAlterado) == true)
                            {
        ...
        private void btExcluir_Click(object sender, EventArgs e)
        {
            ...
            if (resposta == DialogResult.Yes)
            {
                if (nTipo.ExcluirTipoAtendimento(tipoAtendimento) == true)
                {
                    //Criando Caixa de dialogo
        ...
        private void FrmAlterarCadastrarExcluirTipoAtendimento_KeyDown(object sender, KeyEventArgs e)
        {
