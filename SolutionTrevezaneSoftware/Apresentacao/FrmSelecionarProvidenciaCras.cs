...
{
    public partial class FrmSelecionarProvidenciaCras : Form
    {
        ...
        public FrmSelecionarProvidenciaCras([Optional] string descricao)
        {
            InitializeComponent();
        ...
        private void AtualizarDataGrid()
        {
            ...
            {
                this.dgvSelecionar.Rows.Add(this.providenciaLista.Count);
            }
            else
            {
                return;
            ...
            {
                this.dgvSelecionar[0, indice].Value = prov.idProvidencia;
                this.dgvSelecionar[1, indice].Value = prov.descricaoProvidencia;
        ...
        private void btCadastrar_Click(object sender, EventArgs e)
        {
            ...
            FrmAlterarCadastrarExcluirProvidenciaCras formulario = new FrmAlterarCadastrarExcluirProvidenciaCras("cadastrar");
        ...
        private void btAlterar_Click(object sender, EventArgs e)
        {
            try
            {
                if (dgvSelecionar.RowCount > 0)
                {
                    ...
                    foreach (Providencia prov in providenciaLista)
                    {
                        if (prov.idProvidencia == indiceRegistroSelecionado)
                        {
                    ...
                    FrmAlterarCadastrarExcluirProvidenciaCras frmAlterarExcluir = new FrmAlterarCadastrarExcluirProvidenciaCras("", providencia);
        ...
        private void FrmSelecionarProvidenciaCras_Load(object sender, EventArgs e)
        {
        ...
        private void FrmSelecionarProvidenciaCras_KeyDown(object sender, KeyEventArgs e)
        {
