...
namespace Apresentacao
{
    public partial class FrmMenuPrincipal : Form
    {
        ...
        private void MostrarMenu()
        {
            ...
            btUsuario.Text = " Usuário&Senha";
            btBackup.Text = "Backup";
            btSair.Text = " Sair";
            btAgenda.Text = " Agenda";
            //Alinha Icones
        ...
        private void FrmMenuPrincipal_Load(object sender, EventArgs e)
        {
            ...
            if (resultado == DialogResult.OK)
            {
                ...
                if (frmLogin.usuarioMenu.usuario != "ADMIN")
                {
        ...
        private void btBackupBanco_Click(object sender, EventArgs e)
        {
            OpenChildForm(new FrmAgenda(), sender);
        }
