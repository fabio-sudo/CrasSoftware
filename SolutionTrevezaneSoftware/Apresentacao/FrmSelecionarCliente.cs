    ...
    public partial class FrmSelecionarCliente : Form
    {
        ...
        private void AtualizarDataGrid()
        {
            ...
            foreach (Cliente clie in this.clienteLista)
            {
                ...
                this.dgvCliente[2, indice].Value = clie.nomeCliente;
                this.dgvCliente[3, indice].Value = clie.sobrenomeCliente;
                this.dgvCliente[4, indice].Value = clie.cpfCliente;

                //Verifica se o Cliente está bloqueado
                if (clie.estatusCliente == "BLOQUEADO")
                {
