...
namespace Apresentacao
{
    public partial class FrmCadastroCliente : Form
    {
        ...
        public Boolean metodoValidaCampos()
        {
            ...
            {
                MessageBox.Show("Informe o protuário do Cliente!",
            ...
            {
                MessageBox.Show("Informe o NIS do Cliente!",
                        "Erro", MessageBoxButtons.OK, MessageBoxIcon.Error);
                tbEmail.Clear();
                tbEmail.Focus();
                   ...
                   try
                    {
                        ...
                        cliente.prontuarioCliente = tbProntuario.Text;
                        cliente.nomeCliente = tbNome.Text;
                        cliente.sobrenomeCliente = tbSobrenome.Text;
                        cliente.nisCliente = mtbNis.Text;
                        ...
                        {
                            cliente.numeroCliente = Convert.ToInt32(tbNumero.Text);
                        }
                        ...
                        cliente.observacaoCliente = tbObservacao.Text;
                        cliente.estatusCliente = lbEstatus.Text;
        ...
        {
            cbEstado.SelectedItem = "São Paulo";
